...
# 2. mode append
# NOTE: Dia akan menambahkan text baru dengan menggunakan append ("a") dan akan copy text lama dibaris kode awal membuat text di saat file sudah ada dengan menggunakan append ("a")
